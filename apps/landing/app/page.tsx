...
export default function Page() {
  return (
    <main className="flex flex-col items-center justify-between min-h-screen p-24 bg-white dark:bg-black">
      <div className="z-10 items-center justify-between w-full max-w-5xl font-mono text-sm lg:flex">
        <p className="fixed top-0 left-0 flex justify-center w-full px-4 pt-8 pb-6 border backdrop-blur-2xl border-neutral-200 dark:border-neutral-800 bg-zinc-200/20 dark:bg-zinc-800/30 from-inherit lg:static lg:w-auto lg:rounded-xl lg:p-4">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-8">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <svg
                className="w-[120px] h-[120px] fill-black dark:fill-white"
                viewBox="0 0 506 50"
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              고성능 모노레포 도구로 개발 속도를 향상시켜보세요
            </p>
          </div>
        </div>
      </div>

      <div className="grid gap-6 mb-32 text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
